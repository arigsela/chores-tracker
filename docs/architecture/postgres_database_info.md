...
Created: 2025-12-03 Status: Operational
...
Connection target: postgresql-cluster-rw.postgresql.svc.cluster.local:5432
Database: n8n (already created)
User: n8n (already created with appropriate permissions)
Method: Use pg_dump from source, psql or pg_restore to this cluster
pg_restore Example
